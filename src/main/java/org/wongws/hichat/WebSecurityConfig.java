...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.inMemoryAuthentication().passwordEncoder(new BCryptPasswordEncoder()).withUser("wws")
				...
				.password(new BCryptPasswordEncoder().encode("lmm")).roles("USER").and().withUser("tzc")
				.password(new BCryptPasswordEncoder().encode("tzc")).roles("USER").and().withUser("zf")
				.password(new BCryptPasswordEncoder().encode("zf")).roles("USER").and().withUser("yz")
				.password(new BCryptPasswordEncoder().encode("yz")).roles("USER").and().withUser("wvv")
